...
class Flystate2PhidgetsAnalog:
	...
	def __init__(self):
		...
		self.defaults = {'v0enable': True, 'v1enable': True, 'v2enable': True, 'v3enable': True,
						 ...
						 'v30': 0.0, 'v3l1': 5.0, 'v3l2': 0.0, 'v3lr': 0.0, 'v3r1': 5.0, 'v3r2': 0.0, 'v3rr': 0.0, 'v3ha': 5.0, 'v3hr': 0.0, 'v3aa': 0.0, 'v3ar': 0.0, 'v3xi': 0.0,  # L+R
						 'autorange': False,
	...
	def update_coefficients_from_params(self):
		self.a = np.array([[self.params['v00'], self.params['v0l1'], self.params['v0l2'], self.params['v0lr'],
							self.params['v0r1'], self.params['v0r2'], self.params['v0rr'], self.params['v0ha'],
							self.params['v0hr'], self.params['v0aa'], self.params['v0ar'], self.params['v0xi']],
						   [self.params['v10'], self.params['v1l1'], self.params['v1l2'], self.params['v1lr'],
							self.params['v1r1'], self.params['v1r2'], self.params['v1rr'], self.params['v1ha'],
							self.params['v1hr'], self.params['v1aa'], self.params['v1ar'], self.params['v1xi']],
						   [self.params['v20'], self.params['v2l1'], self.params['v2l2'], self.params['v2lr'],
							self.params['v2r1'], self.params['v2r2'], self.params['v2rr'], self.params['v2ha'],
							self.params['v2hr'], self.params['v2aa'], self.params['v2ar'], self.params['v2xi']],
						   [self.params['v30'], self.params['v3l1'], self.params['v3l2'], self.params['v3lr'],
							self.params['v3r1'], self.params['v3r2'], self.params['v3rr'], self.params['v3ha'],
							self.params['v3hr'], self.params['v3aa'], self.params['v3ar'], self.params['v3xi']]
						   ],
						  dtype=np.float32
						  )
	...
	def reconfigure_callback(self, config, level):
		...
		rospy.logwarn("""   v0L1:{v0l1} , v0R1:{v0r1} , v0H:{v0ha} """.format(**config))
		rospy.logwarn("""   v1L1:{v1l1} , v1R1:{v1r1} , v1H:{v1ha} """.format(**config))
