...
# init_agent = util.loadpickle(root=root)

env_init = Environment(init_wing_gain=0, init_head_gain=0, init_arena_gain=0)

func = util.stepArray(1, 1, 7)
Kmap = np.matrix(func).T
k = Kmap.shape[0]
